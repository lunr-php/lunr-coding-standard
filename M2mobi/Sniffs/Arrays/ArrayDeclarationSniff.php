 ...
 */
 namespace M2mobi\Sniffs\Arrays;
...
class ArrayDeclarationSniff implements Sniff
{
    ...
    {
        $tokens         = $phpcsFile->getTokens();
        $statementStart = $tokens[$phpcsFile->findFirstOnLine(T_WHITESPACE, $stackPtr, TRUE)]['column'];
